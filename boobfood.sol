...
contract CoinToken is Context, IERC20, Ownable {
	...
	*/
    ...
    address private _charityAddress =
        0x6C6Ad0AB710D0BA84EC037c425b92452616e8270;
    ...
    /*
    Publicly eliminating updateFee functionality for OWNER account.
    function updateFee(
        uint256 _newReflectionFee,
        uint256 _newLiquidityFee,
        uint256 _newCharityFee,
        uint256 _newMarketingFee
    ) public onlyOwner() {
        _REFLECTION_FEE = _newReflectionFee * 50;
        _LIQUIDITY_FEE = _newLiquidityFee * 50;
        _CHARITY_FEE = _newCharityFee * 50;
        _MARKETING_FEE = _newMarketingFee * 50;
    ...
    */
    ...
    /* Publicly eliminating MINT functionality for OWNER account.
	...
	*/
    ...
    function _getValues(uint256 tAmount) private view returns (Values memory) {
        ...
        //(uint256 tFee, uint256 tLiquidity, uint256 tCharity, uint tMarketing) = _getTBasics(tAmount, _REFLECTION_FEE, _LIQUIDITY_FEE, _CHARITY_FEE, _MARKETING_FEE);
        TBasics memory tb =
            _getTBasics(
                tAmount,
                _REFLECTION_FEE,
    ...
    function _getTBasics(
        ...
        TBasics memory tb = TBasics(tFee, tLiquidity, tCharity, tMarketing);
        return tb;
    }
    ...
    function getTTransferAmount(
        ...
        return tAmount.sub(tFee).sub(tLiquidity).sub(tCharity).sub(tMarketing);
    }
